...
st.markdown('4:Turmeric Adulterants Detection using Microscope Images: Ensuring the purity of turmeric is essential for consumer safety and market integrity. YellowRoot employs machine learning techniques to analyze microscope images and detect adulterants mixed with turmeric. By identifying foreign substances, our system helps maintain the authenticity and quality of turmeric products.)
